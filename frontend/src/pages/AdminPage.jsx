                            ...
                            {active && (
                              <button
                                ...
                                className={`rounded-full px-2 py-1 text-xs transition ${
                                  hasSpecial
                                    ? 'text-[#2AD1C9] bg-[#0399FF]/15 border border-[#0399FF]/40'
                                    : 'text-slate-500 border border-slate-300 hover:text-[#0399FF] hover:border-[#0399FF]/40 dark:border-slate-700/50 dark:hover:text-[#2AD1C9]'
                                }`}
                            ...
                            <div key={day.value} className="flex items-center gap-1">
                              ...
                              {active && (
                                <button
                                  ...
                                  className={`rounded-full px-2 py-1 text-xs transition ${
                                    hasSpecial
                                      ? 'text-[#0399FF] bg-[#0399FF]/15 border border-[#0399FF]/40 dark:text-[#2AD1C9] dark:border-[#2AD1C9]/40'
                                      : 'text-slate-400 border border-slate-300 hover:text-[#0399FF] hover:border-[#0399FF]/40 dark:border-slate-700/50 dark:hover:text-[#2AD1C9]'
                                  }`}
                                  title={hasSpecial ? 'Quitar horario especial' : 'Agregar horario especial'}
                                >
                                  {hasSpecial ? '⏰' : '+'}
